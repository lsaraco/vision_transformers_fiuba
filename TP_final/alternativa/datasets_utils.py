...
class Gaze360Dataset(Dataset):
    ...
    def __init__(self, dataset_path,images_limit=1000,random=True,transform=None,yaw_limits=[-1.5,1.5]):
        ...
        for i in indices:
            ...
            if self.is_angle_within_limits(eye_gaze_2d,yaw_limits[0],yaw_limits[1],"yaw"):
                # Append to list
                self.images_list.append(image_np)
    ...
    def __getitem__(self, idx):
        ...
        label = torch.tensor(self.gaze_list[idx],dtype=torch.float32)
